...
<body>
  ...
  <ol>
    ...
    <li><a href="lista_equipos.php">Listar equipos</a>
    ...
    <li><a href="insertar_datos_jugador_form.php">Insertar datos jugador al formulario</a>
      
    </li>
    <li><a href="lista_jugadores.php">Listar jugadores</a>
    ...
    <li><a href="insertar_datos_posicion_form.php">Insertar datos de posicion al formulario</a>
      
    </li>
    <li><a href="lista_posicion.php">Listar posiciones</a>
    ...
    <li><a href="resetear.php">resetea la base de datos</a>
      <?php
